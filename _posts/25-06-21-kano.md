...
<p align="center">
    <img src="/assets/images/posts/2025/kano_flow_chart.png" width="auto" height="400" loading="lazy"/>
    <br>
    <em> This is my algorithm for sorting features in to the Kano model categories. </em>
</p>
...
We began by brainstorming all the kind of problems we had when working with previous prototype, and what we needed to improve. This included categories like:
...
We sorted all these ideas using the algorithm above. We also brainstormed a few ideas of what would be really cool to implement (if we had the time).
...
We each received $n = 15 / 3 = 5$ (number of ideas divided by 3) votes to place on what we thought was most important to work on. Notice that we _did not_ vote on the basic features / minimum requirements. These must be done.
...
4. Integrate the Kano model with other tools:
   ...
   etc.
5. Innovative features migrate to minimum requirements over time.s
